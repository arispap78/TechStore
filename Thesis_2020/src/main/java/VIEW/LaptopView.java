...
public class LaptopView extends javax.swing.JFrame {
    ...
    //the choice of the user,it will be used also in the class LaptopModelView
    static String choosenLap;
    //the chosen model
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaptopView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
