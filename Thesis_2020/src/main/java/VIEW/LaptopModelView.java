...
import MODEL.Laptop;
import static VIEW.LaptopView.choosenLap;
import java.util.ArrayList;
import java.util.List;
import javax.swing.JOptionPane;

public class LaptopModelView extends javax.swing.JFrame 
{
    /**
     * Creates new form LaptopModelView
     */
    public LaptopModelView() 
    {
        initComponents();
        //display on the center of the screenς
        this.setLocationRelativeTo(null);    
    }

    public LaptopModelView(String a) 
    {
        //the instance of the model which the user has chosen
        Laptop laptop=(Laptop)view.getChoosenModelLap(a,"Laptop");
        //the attributes of the model 
        memory=String.valueOf(laptop.getMemory());
        serialNumber=laptop.getSerialNumber();
        weight=String.valueOf(laptop.getWeight());
        price=String.valueOf(laptop.getPrice());
        quantity=String.valueOf(laptop.getQuantity());
        screen=String.valueOf(laptop.getScreen());
        year=String.valueOf(laptop.getYear());
        ram=String.valueOf(laptop.getRam());
        brand=laptop.getBrand();
        model=laptop.getModel();
        os=laptop.getOs();
        cpu=laptop.getCpu();
        //the list of the suggestion models
        models = view.getSuggestionsLap(laptop);
    ...
    private void initComponents() {
        ...
        setTitle("LAPTOP MODEL");

        jLabel1.setFont(new java.awt.Font("Tempus Sans ITC", 1, 36)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText(choosenLap);
    ...
    private void jComboBoxSuggestionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxSuggestionsActionPerformed
        ...
        if(choosenLap==null)
        {
            ...
            choosenLap=jComboBoxSuggestions.getSelectedItem().toString();
            //if there is no choice
            if(choosenLap=="SIMILAR MODELS...")
            {
            ...
            else
            {
                ...
                String[] s=choosenLap.split(":");
                //the model
                String epilogi=s[1];
                //display the model
                new LaptopModelView(epilogi).setVisible(true);
            }                    
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaptopModelView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaptopModelView().setVisible(true);
            }
        });
    }
